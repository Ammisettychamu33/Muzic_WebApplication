...
const albumsData = {
  telugu: [
    ...
    },
    {
      ...
      year: 2023,
      genre: 'Action',
      cover: 'https://cdn.telugu360.com/wp-content/uploads/2023/12/Salaar-Movie-Review.jpg',
  ...
  hindi: [
    {
      ...
      audio: 'https://pagalfree.com/download/320-Papa%20Meri%20Jaan%20-%20Animal%20320%20Kbps.mp3',
    ...
    },
    {
      ...
      year: 2023,
      genre: 'Action',
      cover: 'https://assets-in.bmscdn.com/discovery-catalog/events/et00323848-uyzcxqehfr-landscape.jpg',
      link: 'https://www.google.com/search?q=Pathaan+album',
      audio: 'https://pagalfree.com/download/128-Jhoome%20Jo%20Pathaan%20-%20Pathaan%20128%20Kbps.mp3',
    ...
    },
    {
      ...
      year: 2022,
      genre: 'Fantasy',
      cover: 'https://upload.wikimedia.org/wikipedia/en/e/ea/Brahmastra_Part_One_Shiva.jpg',
      link: 'https://www.google.com/search?q=Brahmastra+album',
      audio: 'https://pagalfree.com/download/128-Kesariya%20-%20Brahmastra%20128%20Kbps.mp3',
      video: 'https://www.youtube.com/embed/b2h8S7zD_48?si=QX22A3eIZRv_5sZD',
    },
    {
      id: 8,
      title: 'Kabir Singh',
      ...
      audio: 'https://pagalfree.com/download/128-Bekhayali%20-%20Kabir%20Singh%20128%20Kbps.mp3',
  ...
  english: [
    {
      ...
      audio: 'https://www.boomplay.com/songs/76901206?srModel=COPYLINK&srList=WEB',
      video: 'https://www.youtube.com/embed/6LxAwNdyl3I?si=vaQ-nYlMxZwQizvI',
    },
    {
      id: 14,
      title: 'After Hours',
    ...
    },
    {
      ...
      year: 2022,
      genre: 'R&B',
      cover: 'https://www.wallartarena.in/cdn/shop/files/THE_WEEKND_DAWN_FM_ALBUM_POSTER_POSTER_3.jpg?v=1726492147&width=1946',
      link: 'https://www.google.com/search?q=Dawn+FM+album',
      audio: '[archiveorg the-weeknd-dawn-fm-alternate-world-cd width=640 height=60 frameborder=0 webkitallowfullscreen=true mozallowfullscreen=true]',
    ...
    },
    {
      ...
      audio: 'https://open.spotify.com/track/0Jlcvv8IykzHaSmj49uNW8?si=7e17333f1c684a93',
      video: 'https://www.youtube.com/embed/u9xsgqHR1oc?si=63VJjG4wnci9zAau',
    },
  ],
};
